...
2. Aplicar as migrações do banco automaticamente
3. Popular o banco com dados de exemplo via `load.py`
4. Subir o Django em **http://localhost:8000**
5. Subir o React em **http://localhost:5173**
